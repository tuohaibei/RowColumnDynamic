<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectUsers.aspx.cs" Inherits="TCL.Resources.Web.SelectOrg.SelectUsers" %>
...
<head runat="server">
    ...
    <link href="../Scripts/jqueryPlugs/jquery-easyui-1.2.5/themes/gray/easyui.css" rel="stylesheet" type="text/css" />
    <link href="../Scripts/jqueryPlugs/jquery-easyui-1.2.5/themes/gray/tree.css" rel="stylesheet" type="text/css" />
    <link href="../Scripts/jqueryPlugs/jquery-easyui-1.2.5/themes/gray/layout.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="../Scripts/customJS/peopleEdit.js"></script>
</head>
<style type="text/css">
    #tb_userinfo td
    {
...
<body>
    ...
    <div style="width: 100%;">
        <table cellpadding="0" cellspacing="0" style="width: 100%;">
            <tr>
                <td style="width: 60px;">
                    <input type="button" value="组织>>" style="padding-top: 6px; padding-bottom: 10px;
