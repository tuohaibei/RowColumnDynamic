...
var BuildHtml = function (data, ArrayYearMonth) {
    ...
    for (var i = 0; i < obj.length; i++) {
        ...
        for (var j = 0; j < ArrayYearMonth.length; j++) {
            ...
            var input = "<input id='" + id + "' class='input_width input_sr' onchange='totalValue(this)' data='0' type='text' ProjectName='" + obj[i].ProjectName + "' orgidL1Name='" + obj[i].OrgLvl1Txt + "' orgidL2Name='" + obj[i].OrgLvl2Txt + "' orgidL3Name='" + obj[i].OrgLvl3Txt + "' orgidL4Name='" + obj[i].OrgLvl4Txt + "' orgidL4='" + obj[i].OrgLvl4 + "'" +
